...
public class FirstScheduler {
	public static void main(String[] args) throws SchedulerException {
		...
		JobDetail jobDetail = JobBuilder.newJob(FirstJob.class)//获取JobDetail实例，并绑定FisrtJob类
				...
				.usingJobData("jobMsg", "this is jobDetail message.")//使用jobDataMap中的数据
				.build();
		...
		Trigger trigger = TriggerBuilder.newTrigger()//过去trigger实例
				...
				.usingJobData("trMsg", "this is trigger message.")//使用jobDataMap中的数据
				.usingJobData("trDouble", 3.0)//使用jobDataMap中的数据
				.startNow()
